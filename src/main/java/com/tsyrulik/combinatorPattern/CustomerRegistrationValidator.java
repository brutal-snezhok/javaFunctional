...
import static com.tsyrulik.combinatorPattern.CustomerRegistrationValidator.ValidationResult.*;
...
public interface CustomerRegistrationValidator extends Function<Customer, ValidationResult> {
    ...
    static CustomerRegistrationValidator isPhoneNumberValid() {
        return customer -> customer.getPhoneNumber().startsWith("+") ? SUCCESS : PHONE_NUMBER_NOT_VALID;
    }
